...
import bus from "./../components/scene-national-map/Bus"
...
export default (router) => {
    ...
    router.beforeEach(async (to, from, next) => {
        ...
        // 入场路由
        // bus.$emit('scene-national-map-initAnima', to)

        // bus.$emit('scene-wuxi-initAnima', to)

        // bus.$emit('scene-xlxz-initAnima', to)
